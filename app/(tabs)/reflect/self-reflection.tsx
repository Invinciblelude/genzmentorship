...
export default function SelfReflectionScreen() {
  ...
  const [prompts] = useState([
    "What are my greatest strengths and how can I use them?",
    "What goals do I have for myself and my family?",
    "What makes me feel proud and accomplished?",
    "What challenges have I overcome and what did I learn?",
    "How do I want to grow and develop in the next few years?",
  ]);
